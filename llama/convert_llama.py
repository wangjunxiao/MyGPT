...
def get_args():
    ...
    parser.add_argument("--ckpt_dir", type=str, default="../llama_model/7B")
    parser.add_argument(
        "--tokenizer_path", type=str, default="../llama_model/tokenizer.model"
    )
    parser.add_argument(
        "--model_size",
...
if __name__ == "__main__":
    '''
    args = get_args()
    args.output_dir = "hf/llama_model_hf/"
    args.model_size = "7B"
    args.to = "hf"
    if args.to == "hf":
    ...
    '''
    from llama.hf.tokenization_llama import LlamaTokenizer
    tokenizer = LlamaTokenizer.from_pretrained("hf/llama_model_hf/tokenizer/")
    from llama.hf.modeling_llama import LlamaForCausalLM
    model = LlamaForCausalLM.from_pretrained("hf/llama_model_hf/llama-7b/")
    ...
    args = get_args()
    args.output_dir = "../llama_model_fb/"
    args.model_size = "7B"
    args.to = "fb"
    if args.to == "hf":
        convert_llama_hf(args)
